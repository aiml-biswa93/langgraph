...
* The easiest way is to use the project setup script (after filling in the root `.env`):
```
source setup-env.sh
```
* Or, run this from the command line to create these files for module 1 to 5 manually:
```
for i in {1..5}; do
